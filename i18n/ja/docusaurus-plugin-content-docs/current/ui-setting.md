...
| メソッド | エンドポイント | 説明 |
|--------|----------|-------------|
| GET | `/settings` | すべての設定を一覧表示 |
| GET | `/settings/:pk/:sk` | 特定の設定を取得 |
| POST | `/settings` | 新しい設定を作成 |
| PUT | `/settings/:pk/:sk` | 設定を更新 |
| DELETE | `/settings/:pk/:sk` | 設定を削除 |

### データ設定エンドポイント

| メソッド | エンドポイント | 説明 |
|--------|----------|-------------|
| GET | `/data-settings` | すべてのデータ設定を一覧表示 |
| GET | `/data-settings/:pk/:sk` | 特定のデータ設定を取得 |
| POST | `/data-settings` | 新しいデータ設定を作成 |
| PUT | `/data-settings/:pk/:sk` | データ設定を更新 |
| DELETE | `/data-settings/:pk/:sk` | データ設定を削除 |
