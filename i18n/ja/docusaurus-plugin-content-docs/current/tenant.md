...
**v1.0.xからアップグレードする場合** データマイグレーションの手順については[v1.1.0 マイグレーションガイド](/docs/migration/v1.1.0)を参照してください。
:::
...
- [認証](/docs/authentication) - テナントベースの認証
- [キーパターン](/docs/key-patterns) - テナントキー設計
