...
## Delete操作（論理削除） {#delete-operation}
...
## チャンク化バッチ操作 {#chunked-batch-operations}
...
## History Serviceの使用 {#history-service}
...
- [コントローラー](/docs/controllers) - サービスに委譲するコントローラーレイヤー
