...
## エンティティタイプの概要 {#entity-types-overview}
...
- プロパティ: `pk`、`sk`、`id`、`code`、`name`、`version`、`tenantCode`（オプション）、`type`、`isDeleted`、`seq`、`ttl`、`attributes`
...
## Create/Update DTO {#create-update-dtos}
...
## Detail/Search DTO {#detail-search-dtos}
