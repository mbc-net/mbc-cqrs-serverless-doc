...
## ui-commonコマンド {#ui-common-command}
...
| `/mbc-review` | ベストプラクティスとアンチパターン（22パターン）のコードレビュー |
...
- [AIプロンプトライブラリ](/docs/ai-prompts) - モジュール・サービス生成に最適化されたプロンプト集
