---
sidebar_position: 7
description: マルチテナントサーバーレスアプリケーションでのファイルとフォルダー管理のためのS3統合を持つディレクトリ管理モジュール。
---
