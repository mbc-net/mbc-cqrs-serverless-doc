...
## 例1: シンプルなエンティティ同期 {#example-simple-sync}
...
## 例2: SKプレフィックスによる条件処理 {#example-sk-prefix}
...
## 例3: 複雑な属性変換 {#example-attribute-transform}
...
## 例4: PKプレフィックスフィルタリング {#example-pk-filtering}
...
## 例5: SKからのデータ抽出 {#example-sk-parsing}
