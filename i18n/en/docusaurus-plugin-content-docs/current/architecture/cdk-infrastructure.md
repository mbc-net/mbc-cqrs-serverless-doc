---
sidebar_position: 5
description: Learn about AWS CDK infrastructure provisioning and system architecture in the MBC CQRS Serverless framework.
---
...
| `graphqlApiKey` | AppSync API key |
| `httpApiUrl` | HTTP API endpoint |
| `httpDistributionDomain` | CloudFront custom domain |
| `stateMachineArn` | Command Handler State Machine ARN |
| `sfnTaskStateMachineArn` | Task Handler State Machine ARN |
