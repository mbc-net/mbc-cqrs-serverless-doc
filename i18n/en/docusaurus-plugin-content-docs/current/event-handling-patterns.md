...
- [Backend Development Guide](./backend-development.md) - Core patterns
- [Custom Event](./custom-event.md) - Event configuration
- [Step Functions](./architecture/step-functions.md) - Workflow orchestration
- [Data Sync Event](./data-sync-event.md) - Data synchronization
