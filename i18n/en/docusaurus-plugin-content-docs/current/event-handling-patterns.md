...
export class ProductDataSyncRdsHandler implements IDataSyncHandler<void, void> {
  ...
  async up(cmd: CommandModel): Promise<void> {
    ...
    const sk = removeSortKeyVersion(cmd.sk); // Strip @version suffix from command sk
...
- [Notification Module](/docs/notification-module) - Event-triggered notifications and email
