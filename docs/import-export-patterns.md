...
- [Backend Development Guide](./backend-development.md) - {{Core backend patterns / コアバックエンドパターン}}
- [Service Patterns](./service-patterns.md) - {{Service implementation / サービス実装}}
- [Step Functions](./architecture/step-functions.md) - {{Workflow orchestration / ワークフローオーケストレーション}}
- [Data Sync Handler Examples](./data-sync-handler-examples.md) - {{Sync handler patterns / 同期ハンドラーパターン}}
