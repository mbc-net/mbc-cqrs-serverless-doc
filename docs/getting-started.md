...
| ---------------------------- | ---------------------------- |
| {{CQRS framework for AWS serverless}}          | {{- Structured approach for separating commands and queries. <br/>- Integration with AWS services like Cognito, API Gateway, Lambda, DynamoDB, SNS, and SQS, Step Functions, RDS ⚡}}    |
