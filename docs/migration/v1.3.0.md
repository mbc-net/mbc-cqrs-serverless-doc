...
- [{{Changelog v1.3.0}}](/docs/changelog#v130) - {{v1.3.0 release notes}}
- [{{Email Service}}](/docs/email-service) - {{nodemailer configuration and TLS security}}
- [{{Notification Module}}](/docs/notification-module#appsync-events-service) - {{AppSync Events setup and configuration}}
